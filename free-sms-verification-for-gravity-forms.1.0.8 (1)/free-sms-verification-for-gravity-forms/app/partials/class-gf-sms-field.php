...
class GF_SMS_Field extends \GF_Field {
	...
	public function get_form_editor_field_settings() {
		return array(
			...
			'placeholder_setting',
			'firebase_countries',
			'firebase_default_country',
			'firebase_recpatcha_type',
			'css_class_setting',
			'size_setting',
			'admin_label_setting',
	...
	public function get_form_editor_inline_script_on_page_render() {
		...
		"var firebase_default_country = field.firebase_default_country == undefined ? '' : field.firebase_default_country;" .
		"var firebase_recpatcha_type = field.firebase_recpatcha_type == undefined ? '' : field.firebase_recpatcha_type;" .
		"jQuery('#firebase_countries').val(firebase_countries).trigger('change');" .
		"jQuery('#firebase_recpatcha_type').val(firebase_recpatcha_type).trigger('change');" .
		"jQuery('#firebase_default_country').val(firebase_default_country).trigger('change');" .
		'});' . PHP_EOL;

		// saving the simple setting.
		$script .= "function setWhitelistedCountries(value) {SetFieldProperty('firebase_countries', value);}" . PHP_EOL;
		$script .= "function setDefaultCountry(value) {SetFieldProperty('firebase_default_country', value);}" . PHP_EOL;
		$script .= "function setRecaptchaType(value) {SetFieldProperty('firebase_recpatcha_type', value);}" . PHP_EOL;
		return $script;
	}
