<?php
/**
 * Plugin Name: Free SMS OTP Verification for Gravity Forms By Firebase
...
define( 'GF_FREE_SMS_VERIFICATION_VERSION', '1.0.8' );
define( 'GF_FREE_SMS_VERIFICATION_PATH', plugin_basename( __FILE__ ) );
